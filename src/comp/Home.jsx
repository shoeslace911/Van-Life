...
export default function Home() {
  return (
    <div className="font-inter flex ">
      ...
      <div className="relative w-screen h-screen flex items-center gap-52">
        <div>
        ...
        <button className="text-align-center text-black text-xl transition ease-in-out hover:bg-orange-300 hover:scale-105 bg-orange-200 py-5 px-12 items-center rounded-full w-52">
